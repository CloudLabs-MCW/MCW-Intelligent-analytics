...
5. Within the **Create QnA Maker** form in Azure, provide the following:
    ...
    - **App name**: Provide a **unique name** for the QnA Maker Service (e.g., **awhotel-qna-<inject key="DeploymentID" enableCopy="false"/>**).
...
2. Enter the **Web App Bot** configuration as follows:
    ...
    - **Bot handle**: Enter the Bot name, e.g. **awhotel-qna-bot-<inject key="DeploymentID" enableCopy="false"/>**.
