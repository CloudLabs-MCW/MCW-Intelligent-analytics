...
1. Unzip the contents of the ZIP file in the same folder **C:\\ConciergePlus**\\.
...
3. On the Create Web App blade, enter the following:
    ...
    - **Name**: Provide **a unique name** that is indicative of this resource being used to host the concierge+ chat website (e.g., **concierge-<inject key="DeploymentID" enableCopy="false"/>**).
...
2. On the Function App form, enter the following on the **Basics** tab:
    ...
    - **App Name**: Provide **a unique name** that is indicative of this resource being used to process chat messages (e.g., **chatprocessor-<inject key="DeploymentID" enableCopy="false"/>**).
...
3. On the Create namespace blade enter the following:
    ...
    - **Name**: Provide a unique name for the namespace (e.g., **awhotel-<inject key="DeploymentID" enableCopy="false"/>**). 
...
1. In the Azure portal left menu, select **+Create a resource**, then search for `Event Hubs`.
...
2. On the **Create namespace** blade enter the following:
    ...
    - **Namespace name**: Provide a unique name for the namespace (e.g., **awhotel-events-<inject key="DeploymentID" enableCopy="false"/>**).
...
1. In the Azure portal, select **+Create a resource**.  Search for **Azure Cosmos DB**.
...
3. On the **Basics** blade, enter the following:
    ...
    - **Account Name**: Provide a unique name for the Azure Cosmos DB account (e.g., **awhotelcosmosdb-<inject key="DeploymentID" enableCopy="false"/>**).
...
2. On the **New Search Service** blade, enter the following:
    ...
    - **Service name**: Provide a **unique name** for the search service (e.g., **coniergeplusapp-<inject key="DeploymentID" enableCopy="false"/>**).
...
2. On the **New Stream Analytics Job** blade, enter the following:
    ...
    - **Job Name**: Enter **MessageLogger-<inject key="DeploymentID" enableCopy="false"/>**.
...
1. In the Azure portal left menu, select **+Create a resource**, search for `Storage account`, then select **Storage account**.  Select the Create button on the resource overview page.
...
2. In the **Create storage account** form, **Basics** tab, enter the following:
    ...
    - **Storage account name**: Provide a unique name for the account e.g., **awhotelchatstore-<inject key="DeploymentID" enableCopy="false"/>**.
...
1. From the Azure portal left menu, select **+Create a resource**, then search for `Text Analytics`
...
3. On the **Create** blade, enter the following:
    ...
    - **Name**: Enter a unique name like **awhotels-sentiment-<inject key="DeploymentID" enableCopy="false"/>**.
...
9. On the **Basics** tab, populate the form fields as follows:
    ...
    - **Name**: Enter a unique name, like **luis-api-namespace-<inject key="DeploymentID" enableCopy="false"/>**, where namespace may be your initials.
