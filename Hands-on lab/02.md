...
3. On the Create Web App blade, enter the following:
    ...
    - **Name**: Provide **a unique name** that is indicative of this resource being used to host the **concierge-<inject key="DeploymentID" enableCopy="false"/>** chat website (e.g., `conciergepluschatapp + (namespace)`).
