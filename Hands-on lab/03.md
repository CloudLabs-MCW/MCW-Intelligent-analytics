...
1. Open the **ConciergePlusSentiment.sln** file that you downloaded using Visual Studio, if it is not already open.
...
1. In the Azure portal, open the Cognitive Service Text API (e.g. **awhotels-sentiment-<inject key="DeploymentID" enableCopy="false"/>**) in your resource group.
